namespace SAPWebPortal.ARInvoiceLine {
    export namespace DocumentLineService {
        export const baseUrl = 'ARInvoiceLine/DocumentLine';
        ...
        export declare const enum Methods {
            Create = "ARInvoiceLine/DocumentLine/Create",
            Update = "ARInvoiceLine/DocumentLine/Update",
            Delete = "ARInvoiceLine/DocumentLine/Delete",
            Retrieve = "ARInvoiceLine/DocumentLine/Retrieve",
            List = "ARInvoiceLine/DocumentLine/List",
            GetGLAccounts = "ARInvoiceLine/DocumentLine/GetGLAccounts"
        }
