...
{
    [ConnectionKey("Default"), Module("ARInvoiceLine"), ServiceLayer("ARInvoiceLine")]
    [DisplayName("Document Line"), InstanceName("Document Line")]
    [InsertPermission(MarketingDocsPermissionKeys.ARInvoice.Insert)]
    [ModifyPermission(MarketingDocsPermissionKeys.ARInvoice.Modify)]
    [DeletePermission(MarketingDocsPermissionKeys.ARInvoice.Delete)]
    [ReadPermission(MarketingDocsPermissionKeys.ARInvoice.View)]
    [NotMapped]
    public sealed class DocumentLineRow : Row<DocumentLineRow.RowFields>, IIdRow
    {
        ...
        [DisplayName("Item Description"), SAPDBFieldName("Dscription")]
        [NotMapped]
        ...
        [DisplayName("Account Name"), SAPDBFieldName("AcctName")]
        [NotMapped]
        ...
        [DisplayName("Unit Price"), SAPDBFieldName("Price"), Width(150)]
        [NotMapped]
        ...
        [DisplayName("Warehouse Code"), SAPDBFieldName("WhsCode"), _Ext.GridItemPickerEditor(typeof(WarehouseRow))]
        [NotMapped]
        ...
        [DisplayName("Tax Code"), SAPDBFieldName("VatGroup"), _Ext.GridItemPickerEditor(typeof(VatGroupRow))]
        [NotMapped]
        ...
        [DisplayName("UoM"), SAPDBFieldName("UoMCode"), ReadOnly(true)]
        [NotMapped]
        ...
        [DisplayName("Line Total"), SAPDBFieldName("LineTotal"), ReadOnly(true)]
        [NotMapped]
        ...
        [DisplayName("Gross Total"), SAPDBFieldName("GrossTotal"), ReadOnly(true)]
        [NotMapped]
        ...
        [DisplayName("Base Entry"), SAPDBFieldName("BaseEntry")]
        [NotMapped]
        ...
        [DisplayName("Base Line"), SAPDBFieldName("BaseLine")]
        [NotMapped]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            //public StringField ConsumerSalesForecast;
            ...
            //public StringField DistributeExpense;
            ...
            //public StringField WithoutInventoryMovement;
            ...
            //public StringField ConsiderQuantity;
            //public StringField PartialRetirement;
            //public DecimalField RetirementQuantity;
            //public DecimalField RetirementApc;
            //public StringField ThirdParty;
            ...
            //public StringField EnableReturnCost;
            ...
            //public StringField ChangeInventoryQuantityIndependently;
            //public StringField FreeOfChargeBp;
