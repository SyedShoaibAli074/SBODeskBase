...
using System.Data;
using System.Linq;
using MyRow = SAPWebPortal.Administration.Entities.RolePermissionRow;
...
namespace SAPWebPortal.Administration.Repositories
{
    public class RolePermissionRepository : BaseRepository
    {
        ...
        private System.Collections.Generic.List<MyRow> GetExisting(IDbConnection connection, Int32 roleId, string module, string submodule)
        {
            string prefix = "";
