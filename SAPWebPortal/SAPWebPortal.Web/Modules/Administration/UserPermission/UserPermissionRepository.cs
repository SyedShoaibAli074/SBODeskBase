...
using MyRow = SAPWebPortal.Administration.Entities.UserPermissionRow;

namespace SAPWebPortal.Administration.Repositories
{
    public class UserPermissionRepository : BaseRepository
    {
        ...
        private System.Collections.Generic.List<MyRow> GetExisting(IDbConnection connection, Int32 userId, string module, string submodule)
        {
            string prefix = "";
