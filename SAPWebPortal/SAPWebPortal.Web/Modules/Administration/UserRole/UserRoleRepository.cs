...
using MyRow = SAPWebPortal.Administration.Entities.UserRoleRow;
...
namespace SAPWebPortal.Administration.Repositories
{
    public class UserRoleRepository : BaseRepository
    {
        ...
        private System.Collections.Generic.List<MyRow> GetExisting(IDbConnection connection, Int32 userId)
        {
