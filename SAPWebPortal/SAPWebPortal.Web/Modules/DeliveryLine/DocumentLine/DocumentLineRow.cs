...
{
    [ConnectionKey("Default"), Module("DeliveryLine"), ServiceLayer("DeliveryNotesLine")]
    ...
    public sealed class DocumentLineRow : Row<DocumentLineRow.RowFields>, IIdRow
    {
        ...
        [DisplayName("Item Code"), _Ext.GridItemPickerEditor(typeof(ItemRow)) ]
        [NotMapped]
        ...
        [DisplayName("Item Description"),ReadOnly(true)]
        [NotMapped]
        ...
        [DisplayName("Quantity"), ReadOnly(true)]
        [NotMapped]
        ...
        [DisplayName("UOM Quantity"), ReadOnly(true)]
        [NotMapped]
        ...
        [DisplayName("Price After Vat"), Column("PriceAfterVAT") ]
        [NotMapped]
        ...
        [DisplayName("Account Code"), _Ext.GridItemPickerEditor(typeof(ChartOfAccountRow))]
        [NotMapped]
