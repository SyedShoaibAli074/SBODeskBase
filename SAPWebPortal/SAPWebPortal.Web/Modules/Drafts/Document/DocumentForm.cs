...
namespace SAPWebPortal.Drafts.Forms
{
    [FormScript("Drafts.Document")]
    ...
    public class DocumentForm
    {
        ...
        [Tab("Contents"), ReadOnly(true)]
        [MediumThirdLargeQuarterWidth]
        public string DocType { get; set; }
        [DocumentLineEditor, ReadOnly(true)]
        ...
        [Tab("Accounting"), ReadOnly(true)]
        [HalfWidth]
        public Int32 GroupNumber { get; set; }
        [HalfWidth, ReadOnly(true)]
        public string Project { get; set; }
        [Tab("Logistic"), ReadOnly(true)]
        public string PayToCode { get; set; }
        public string ShipToCode { get; set; }
        [FullWidth, ReadOnly(true)]
        public string U_Address { get; set; }

        [Tab("Attachment"), ReadOnly(true)]
