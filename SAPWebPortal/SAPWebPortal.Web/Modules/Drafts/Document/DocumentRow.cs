...
using SAPWebPortal.DraftsExpense;
using SAPWebPortal.DraftsLine;
...
{
    [ConnectionKey("Default"), Module("Drafts"), ServiceLayer("Drafts")]
    [DisplayName("Drafts"), InstanceName("Drafts")]
    [InsertPermission(ApprovalProcessPermissionKeys.Drafts.Insert)]
    [ModifyPermission(ApprovalProcessPermissionKeys.Drafts.Modify)]
    [DeletePermission(ApprovalProcessPermissionKeys.Drafts.Delete)]
    [ReadPermission(ApprovalProcessPermissionKeys.Drafts.View)]
    [NotMapped]
    public sealed class DocumentRow : Row<DocumentRow.RowFields>, IIdRow
    {
        ...
        [DisplayName("Draft Document"), DraftDocsEditor, ReadOnly(true)]
        [NotMapped]
