...
using SAPWebPortal.Orders.Document;

namespace SAPWebPortal.Orders
{
    [ConnectionKey("Default"), Module("Orders"), ServiceLayer("Orders")]
    [DisplayName("Orders"), InstanceName("Orders")]
    [InsertPermission(MarketingDocsPermissionKeys.SalesOrder.Insert)]
    [ModifyPermission(MarketingDocsPermissionKeys.SalesOrder.Modify)]
    [DeletePermission(MarketingDocsPermissionKeys.SalesOrder.Delete)]
    [ReadPermission(MarketingDocsPermissionKeys.SalesOrder.View)]
    [NotMapped]
    public sealed class DocumentRow : Row<DocumentRow.RowFields>, IIdRow
    {
        ...
        [DisplayName("Series"), SAPDBFieldName("Series"), NotNull, SAPWebPortal.Web.Modules.Common.Attributes.SelectCodeNameValueEditor(@$" SELECT ""Series"", ""SeriesName""  FROM NNM1 WHERE NNM1.""ObjectCode"" = '17'")]
        [NotMapped]
        public Int32? Series
        {
        ...
        [DisplayName("Doc Num"), SAPDBFieldName("DocNum")]
        [NotMapped]
        public Int32? DocNum
        {
        ...
        [DisplayName("Customer"), NotNull, SAPDBFieldName("CardCode"), _Ext.GridItemPickerEditor(typeof(BusinessPartnerRow)), QuickSearch]
        [NotMapped]
        ...
        [DisplayName("Doc Total"), NotNull, SAPDBFieldName("DocTotal"), ReadOnly(true)]
        [NotMapped]
        ...
        [DisplayName("Status"), DocStatusEditor, SAPDBFieldName("DocEntry"), DefaultValue("bost_Open")]
        [NotMapped]
        ...
        [DisplayName("Sales Employee"), NotNull, SAPDBFieldName("SlpCode"), SAPWebPortal.Web.Modules.Common.Attributes.SelectCodeNameValueEditor(@$"SELECT T0.""SlpCode"", T0.""SlpName"" FROM OSLP T0 inner join OCRD t1 on t1.""SlpCode"" = t0.""SlpCode""  WHERE ""Active"" ='Y' and t1.""CardCode"" = '@CardCode'")]
        ...
        [DisplayName("Total Discount"), SAPDBFieldName("DiscSum"), ReadOnly(true)]
        [NotMapped]
        ...
        [DisplayName("Remarks"), SAPDBFieldName("Comments"), NotNull]
        [NotMapped]
        ...
        [DisplayName("Address"), NotNull, SAPDBFieldName("DocEntry"), AddressListEditor]
        [NotMapped]
        ...
        {
            get => fields.GroupNum [this];
            set => fields.GroupNum [this] = value;
        }
        ...
        */
        [DisplayName("U_ORDERID")]
        [NotMapped]
        public String U_ORDERID
        {
            get => fields.U_ORDERID[this];
            set => fields.U_ORDERID[this] = value;
        }
        ...
        [DisplayName("U_CUSNAME")]
        [NotMapped]
        public String U_CUSNAME
        {
            get => fields.U_CUSNAME[this];
            set => fields.U_CUSNAME[this] = value;
        }
        [DisplayName("U_CUSNUMBER")]
        [NotMapped]
        public String U_CUSNUMBER
        {
            get => fields.U_CUSNUMBER[this];
            set => fields.U_CUSNUMBER[this] = value;
        }
        ...
        //[NotMapped]
        //public System.Nullable`1[SAPB1.BoObjectTypes]? DocObjectCode
        //{
        ...
        [NotMapped]
        public AddressExtensionRow AddressExtension
        {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField U_ORDERID;
            public StringField U_CUSNAME;
            public StringField U_CUSNUMBER;
            ...
            public RowField<AddressExtensionRow>  AddressExtension;
            ...
            ////public System.Nullable`1[SAPB1.BoObjectTypes]Field DocObjectCode;
