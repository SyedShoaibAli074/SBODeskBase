...
{
    [ConnectionKey("Default"), Module("OrdersLine"), ServiceLayer("OrdersLine")]
    [DisplayName("Document Line"), InstanceName("Document Line")]
    [InsertPermission(MarketingDocsPermissionKeys.SalesOrderLines.Insert)]
    [ModifyPermission(MarketingDocsPermissionKeys.SalesOrderLines.Modify)]
    [DeletePermission(MarketingDocsPermissionKeys.SalesOrderLines.Delete)]
    [ReadPermission(MarketingDocsPermissionKeys.SalesOrderLines.View)]
    [NotMapped]
    public sealed class DocumentLineRow : Row<DocumentLineRow.RowFields>, IIdRow
    {
        ...
        [DisplayName("Account Code"), SAPDBFieldName("AcctCode")]
        [NotMapped]
        ...
        [DisplayName("Inv Quantity"), SAPDBFieldName("InvQty")]
        [NotMapped]
        ...
        [DisplayName("Price"), ReadOnly(true), SAPDBFieldName("Price"), Width(150)]
        [NotMapped]
        ...
        [DisplayName("U_ShopifyOrderLineId"), SAPDBFieldName("U_ShopifyOrderLineId"), ReadOnly(true)]
        [NotMapped]
        public String U_ShopifyOrderLineId
        {
            get => fields.U_ShopifyOrderLineId[this];
            set => fields.U_ShopifyOrderLineId[this] = value;
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField U_ShopifyOrderLineId;
