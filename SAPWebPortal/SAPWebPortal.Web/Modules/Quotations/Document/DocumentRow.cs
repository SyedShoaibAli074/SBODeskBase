...
using SAPWebPortal.QuotationsExpense;
using SAPWebPortal.QuotationsLine;
using Serenity;
...
{
    [ConnectionKey("Default"), Module("Quotations"), ServiceLayer("Quotations")]
    [DisplayName("Quotations"), InstanceName("Quotations")]
    [InsertPermission(MarketingDocsPermissionKeys.SalesQuotations.Insert)]
    [ModifyPermission(MarketingDocsPermissionKeys.SalesQuotations.Modify)]
    [DeletePermission(MarketingDocsPermissionKeys.SalesQuotations.Delete)]
    [ReadPermission(MarketingDocsPermissionKeys.SalesQuotations.View)]
    [NotMapped]
    public sealed class DocumentRow : Row<DocumentRow.RowFields>, IIdRow
    {
        ...
        [DisplayName("Series"), NotNull, SAPDBFieldName("Series"), SAPWebPortal.Web.Modules.Common.Attributes.SelectCodeNameValueEditor(@$" SELECT ""Series"", ""SeriesName""  FROM NNM1 WHERE NNM1.""ObjectCode"" = '23'")]
        [NotMapped]
        public Int32? Series
        {
        ...
        [DisplayName("Posting Date"), SAPDBFieldName("DocDate"), NotNull]
        [NotMapped]
        ...
        [DisplayName("Doc Total"), SAPDBFieldName("DocTotal"), NotNull]
        [NotMapped]
        ...
        [DisplayName("Sales Employee"), NotNull, SAPDBFieldName("SlpCode"), SAPWebPortal.Web.Modules.Common.Attributes.SelectCodeNameValueEditor(@$"SELECT ""SlpCode"", ""SlpName"" FROM OSLP WHERE ""Active"" ='Y'")]
        [NotMapped]
        ...
        [DisplayName("Remarks"), SAPDBFieldName("Comments")]
        [NotMapped]
