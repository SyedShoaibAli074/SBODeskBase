...
namespace _Ext {
            ...
            if (this.isPickerMode()) { //show checkbox column in picker mode
                ...
                if (options.multiple == true) {
                    ...
                    columns.unshift({
                        ...
                        minWidth: 66,
                        maxWidth: 66,
                        format: ctx => '<a class="inline-actions select-row"><i class="select-row fa fa-check-square-o"></i> Select</a>'
                    });
    ...
    export class GridBase1<TItem, TOptions>
        //this comment is for preventing replacement 
        extends Serenity.EntityGrid<TItem, TOptions> {
            ...
            if (this.isPickerMode()) { //show checkbox column in picker mode
                ...
                if (options.multiple == true) {
                    ...
                    columns.unshift({
                        ...
                        minWidth: 66,
                        maxWidth: 66,
                        format: ctx => '<a class="inline-actions select-row" style="color: #00CC66;"><i class="select-row fa fa-check-square-o" style="color: #00994C;"></i> Select</a>'
                    });
        ...
        protected onInlineActionClick(target: JQuery, recordId, item: TItem): void {
            if (target.hasClass('delete-row')) {
                ...
                this.editItem(recordId + "," + localStorage.getItem("DBName"));
            }
            else if (target.hasClass('print-row')) {
                let request: Serenity.RetrieveRequest = { EntityId: recordId };
