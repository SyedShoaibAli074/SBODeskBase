...
namespace _Ext.DevTools.Model
{
    ...
    {
        public System.Collections.Generic.List<TableComparisonInfo> TableComparisonInfos { get; set; } = new System.Collections.Generic.List<TableComparisonInfo>();
    ...
    public class TableComparisonInfo
    {
        ...
        public System.Collections.Generic.List<FieldComparisonInfo> FieldComparisonInfos { get; set; } = new System.Collections.Generic.List<FieldComparisonInfo>();
    ...
    public class FieldComparisonInfo
    {
        ...
        private System.Collections.Generic.List<FieldComparisonIssue> _Issues;
        public System.Collections.Generic.List<FieldComparisonIssue> Issues
        {
            get
            {
                if (_Issues == null)
                {
                    _Issues = new System.Collections.Generic.List<FieldComparisonIssue>();
