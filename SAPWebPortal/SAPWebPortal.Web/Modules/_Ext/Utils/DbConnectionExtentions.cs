...
public static partial class DbConnectionExtentions
{
    ...
    public static System.Collections.Generic.List<string> GetNamesByIds<TRow>(this IDbConnection connection, IEnumerable<Int64> ids)
        where TRow : IRow, IIdRow, INameRow, new()
    {
        var row = new TRow();
    ...
    public static System.Collections.Generic.List<string> GetNamesByIds<TRow>(this IDbConnection connection, IEnumerable<Int32> ids)
        where TRow : IRow, IIdRow, INameRow, new()
    {
        var row = new TRow();
