...
public static partial class Q
{
    ...
    public static System.Collections.Generic.List<Int64> DelimitedToInt64List(string delimitedIds)
    {
        return delimitedIds?.Split(',')?.Select(s => Convert.ToInt64(s))?.ToList() ?? new System.Collections.Generic.List<Int64>();
    }
