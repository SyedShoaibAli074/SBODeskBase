    ...
    public class Program
    {
            ...
            Func<IBuildProjectSystem> projectSystemFactory)
        {
            ...
            try
            {
                ...
                if ("sbogenerate".StartsWith(command, StringComparison.Ordinal))
                {
                    SBOGenerateCommand.Run(csproj, args.Skip(1).ToArray(), fileSystem);
                    return ExitCodes.Success;
                }
            }
            catch (Exception ex)
        ...
        private static void WriteHelp()
        {
            ...
            Console.WriteLine("    sbo[generate]        Launches SAP code generator");
