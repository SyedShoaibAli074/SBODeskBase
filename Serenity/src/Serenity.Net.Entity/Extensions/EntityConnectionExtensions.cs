...
namespace Serenity.Data
{
    ...
    public static class EntityConnectionExtensions
    {
        ...
        public static System.Collections.Generic.List<TRow> List<TRow>(this IDbConnection connection)
            where TRow : class, IRow, new()
        {
        ...
        public static System.Collections.Generic.List<TRow> List<TRow>(this IDbConnection connection, ICriteria where)
            where TRow : class, IRow, new()
        {
            var row = new TRow() { TrackWithChecks = true };
            return new SqlQuery().From(row)
        ...
        public static System.Collections.Generic.List<TRow> List<TRow>(this IDbConnection connection, Action<SqlQuery> editQuery)
            where TRow : class, IRow, new()
        {
            var row = new TRow() { TrackWithChecks = true };
            var query = new SqlQuery().From(row);
