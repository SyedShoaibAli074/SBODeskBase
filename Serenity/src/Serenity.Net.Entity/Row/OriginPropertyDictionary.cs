...
namespace Serenity.Data
{
    internal class OriginPropertyDictionary
    {
        ...
        public string OriginExpression(string propertyName, OriginAttribute origin,
            DialectExpressionSelector expressionSelector, string aliasPrefix, System.Collections.Generic.List<Attribute> extraJoins)
        {
        ...
        internal string PrefixAliases(string expression, string alias,
            DialectExpressionSelector expressionSelector, System.Collections.Generic.List<Attribute> extraJoins)
        {
