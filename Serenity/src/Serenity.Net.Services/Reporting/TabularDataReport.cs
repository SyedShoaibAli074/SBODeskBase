...
namespace Serenity.Reporting
{
    public class TabularDataReport : IDataOnlyReport
    {
        ...
        protected System.Collections.Generic.List<ReportColumn> ColumnList { get; set; }
        ...
        public virtual System.Collections.Generic.List<ReportColumn> GetColumnList()
        {
            if (ColumnList != null)
                return ColumnList;
        ...
        public static System.Collections.Generic.List<ReportColumn> GetColumnListFor(Type columnsType,
            IEnumerable<string> exportColumns, IServiceProvider serviceProvider)
        {
            ...
            var list = new System.Collections.Generic.List<ReportColumn>();
            if (exportColumns != null && !exportColumns.Any())
                return list;

            System.Collections.Generic.List<PropertyItem> propertyItems = null;
