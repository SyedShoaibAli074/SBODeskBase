...
namespace Serenity.Reporting
{
    public static class ReportColumnConverter
    {
        ...
        public static System.Collections.Generic.List<ReportColumn> ObjectTypeToList(Type objectType, 
        ...
        public static System.Collections.Generic.List<ReportColumn> EntityTypeToList(IRow instance, ITextLocalizer localizer)
        {
            var list = new System.Collections.Generic.List<ReportColumn>();
