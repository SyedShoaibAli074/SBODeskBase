...
namespace Serenity.Data
{
    ...
    public static class DisplayOrderHelper
    {
            ...
            bool descendingKeyOrder = false, bool hasUniqueConstraint = false)
        {
            ...
            System.Collections.Generic.List<OrderRecord> orderRecords = new System.Collections.Generic.List<OrderRecord>();
        ...
        public static bool UpdateOrders(IDbConnection connection, System.Collections.Generic.List<OrderRecord> orderRecords,
            string tableName, Field keyField, Field orderField, bool hasUniqueConstraint = false)
        {
            ...
            if (hasUniqueConstraint)
            {
                ...
                var list = new System.Collections.Generic.List<OrderRecord>();
