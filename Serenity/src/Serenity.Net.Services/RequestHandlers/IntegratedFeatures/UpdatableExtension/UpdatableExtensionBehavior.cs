...
namespace Serenity.Services
{
    public class UpdatableExtensionBehavior : BaseSaveDeleteBehavior, IImplicitBehavior
    {
        private class RelationInfo
        {
            ...
            public System.Collections.Generic.List<Tuple<Field, Field>> Mappings;
        ...
        private System.Collections.Generic.List<RelationInfo> infoList;
        ...
        public bool ActivateFor(IRow row)
        {
            ...
            infoList = attrs.Select(attr =>
            {
                ...
                info.Mappings = new System.Collections.Generic.List<Tuple<Field, Field>>();
